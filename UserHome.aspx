          ...
          <div class="nav-container">
            <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
              ...
              <li class="has-sub nav-item"><a href="Contact.aspx"><i class="icon-magnet"></i><span data-i18n="" class="menu-title">Contact US</span></a>
                 ...
                 <li class="has-sub nav-item"><a href="#"><i class="icon-puzzle"></i><span data-i18n="" class="menu-title">Product Price Chart</span></a>
                <ul class="menu-content">
                  <li class="has-sub  nav-item""><a href="#" class="menu-item">Grogeries Price Chart</a>
                      <li  class="has-sub  nav-item""><a href="#" class="menu-item">Fast Foods Price Chart</a>
                      </li>
                      <li class="has-sub  nav-item""><a href="#" class="menu-item">Fruits Price Chart</a>
                      </li>
                      <li class="has-sub  nav-item""><a href="#" class="menu-item">Vegitables Price Chart</a>
                      </li>
                      
                      </li>
                    </ul>
                     </li>
            <li class="has-sub nav-item"><a href="What_Do_You_Want.aspx"><i class="icon-anchor"></i><span data-i18n="" class="menu-title">What You Want</span></a>
                </li>
                 <li class="has-sub nav-item"><a href="OrderThroughCall.aspx"><i class="icon-bar-chart"></i><span data-i18n="" class="menu-title">Order Through Call</span></a>
                </li>
              <li class="has-sub nav-item"><a href="Default.aspx"><i class="icon-basket"></i><span data-i18n="" class="menu-title">Sign Out</span></a>
                </li>
                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="Contact.aspx">Contact Us</a></li>
                             <li><a href="What_Do_You_Want.aspx">What You Want</a></li>
                              <li><a href="OrderThroughCall.aspx">Order Through Call</a></li>
                            <li>
            ...
            <div class="container center">
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        <p><a class="btn btn-default" href="What_Do_You_Want.aspx" role="button">Order &raquo;</a></p>
                    </div>
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-4">
                     ...
                     <div class="col-lg-4">
                        ...
                        <p><a class="btn btn-default" href="What_Do_You_Want.aspx" role="button">Oredr &raquo;</a></p>
                    </div>
                </div>
            </div>
